...
import {Ri24HoursLine, RiFileExcel2Line} from "react-icons/ri";
    ...
    <>
      <Navbar className="shadow-sm rounded">
        <Container fluid>
            ...
            <div
              className='fs-5 dark:bg-black bg-white'
              style={{
              }}
            >
              Horarios
              ...
              <Dropdown.Menu>
                ...
                >
                  <Ri24HoursLine
                    ...
                    className='me-2'
                  />
                  Cambiar formato de horario a {!mostrarPorHorario24Horas ? "12" : "24"} horas
                </Dropdown.Item>
                <Dropdown.Divider />
                ...
                >
                  Exportar horario individual ({pagina + 1})
                </Dropdown.ItemText>
